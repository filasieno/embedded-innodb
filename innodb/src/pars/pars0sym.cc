...
{
  auto sym_tab = reinterpret_cast<sym_tab_t *>(mem_heap_alloc(heap, sizeof(sym_tab_t)));
...
{
  auto node = reinterpret_cast<sym_node_t *>(mem_heap_alloc(sym_tab->heap, sizeof(sym_node_t)));
