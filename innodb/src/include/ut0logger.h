...
#define log_dbg_hdr(args...)                                   \
  do {                                                         \
    if (logger::level <= (int)logger::Debug) {                 \
      logger::write(NOW, FUNC, "dbg", true, false, args);     \
    }                                                          \
  } while (false)
...
#define log_dbg(args...)                                      \
  do {                                                        \
    if (logger::level <= (int)logger::Debug) {                \
      logger::write(NOW, FUNC, "dbg", true, true, args);     \
    }                                                         \
  } while (false)
...
#define log_dbg_msg(args...)                                    \
  do {                                                          \
    if (logger::level <= (int)logger::Debug) {                  \
      logger::write(NOW, FUNC, "dbg", false, false, args);     \
    }                                                           \
  } while (false)
...
#define log_info_hdr(args...)                                   \
  do {                                                          \
    if (logger::level <= (int)logger::Info) {                   \
      logger::write(NOW, FUNC, "inf", true, false, args);      \
    }                                                           \
  } while (false)
...
#define log_info(args...)                                      \
  do {                                                         \
    if (logger::level <= (int)logger::Info) {                  \
      logger::write(NOW, FUNC, "inf", true, true, args);      \
    }                                                          \
  } while (false)
...
#define log_info_msg(args...)                                    \
  do {                                                           \
    if (logger::level <= (int)logger::Info) {                    \
      logger::write(NOW, FUNC, "inf", false, false, args);      \
    }                                                            \
  } while (false)
...
#define log_warn_hdr(args...)                                   \
  do {                                                          \
    if (logger::level <= (int)logger::Warn) {                   \
      logger::write(NOW, FUNC, "wrn", true, false, args);      \
    }                                                           \
  } while (false)
...
#define log_warn(args...)                                      \
  do {                                                         \
    if (logger::level <= (int)logger::Warn) {                  \
      logger::write(NOW, FUNC, "wrn", true, true, args);      \
    }                                                          \
  } while (false)
...
#define log_warn_msg(args...)                                    \
  do {                                                           \
    if (logger::level <= (int)logger::Warn) {                    \
      logger::write(NOW, FUNC, "wrn", false, false, args);      \
    }                                                            \
  } while (false)
...
#define log_err_hdr(args...)                                   \
  do {                                                         \
    if (logger::level <= (int)logger::Error) {                 \
      logger::write(NOW, FUNC, "err", true, false, args);     \
    }                                                          \
  } while (false)
...
#define log_err(args...)                                      \
  do {                                                        \
    if (logger::level <= (int)logger::Error) {                \
      logger::write(NOW, FUNC, "err", false, true, args);    \
    }                                                         \
  } while (false)
...
#define log_err_msg(args...)                                    \
  do {                                                          \
    if (logger::level <= (int)logger::Error) {                  \
      logger::write(NOW, FUNC, "err", false, false, args);     \
    }                                                           \
  } while (false)
...
#define log_fatal(args...)                                   \
  do {                                                        \
    if (logger::level <= (int)logger::Fatal) {                \
      logger::write(NOW, FUNC, "fatal", true, true, args);   \
      ::abort();                                              \
    }                                                         \
  } while (false)
