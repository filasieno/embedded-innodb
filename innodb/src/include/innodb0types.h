...
/* IB destructive interference size value resolution happens after the
   hardware_* alias block below to avoid ordering issues. */
...
#if defined(IB_DESTRUCTIVE_INTERFERENCE_SIZE_OPTION)
constexpr std::size_t IB_CONSTRUCTIVE_INTERFERENCE_SIZE = IB_DESTRUCTIVE_INTERFERENCE_SIZE_OPTION;
constexpr std::size_t IB_DESTRUCTIVE_INTERFERENCE_SIZE  = IB_DESTRUCTIVE_INTERFERENCE_SIZE_OPTION;
#else
constexpr std::size_t IB_CONSTRUCTIVE_INTERFERENCE_SIZE = 64;
constexpr std::size_t IB_DESTRUCTIVE_INTERFERENCE_SIZE  = 64;
// static_assert(std::hardware_destructive_interference_size == 64,  "IB_DESTRUCTIVE_INTERFERENCE_SIZE standard size is 64; set IB_DESTRUCTIVE_INTERFERENCE_SIZE_OPTION to ovveride"); 
// static_assert(std::hardware_constructive_interference_size == 64, "IB_CONSTRUCTIVE_INTERFERENCE_SIZE standard size is 64; set IB_CONSTRUCTIVE_INTERFERENCE_SIZE_OPTION to ovveride"); 
#endif

/** OS file handle */
using os_file_t = int;

// TODO: fix unused includes
#include "innodb0valgrind.h" // IWYU pragma: export
#include "ut0ut.h"           // IWYU pragma: export
