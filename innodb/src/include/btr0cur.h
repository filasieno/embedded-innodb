...
struct Btree_cursor {
  ...
  /**
   * Returns the up_match value after a search.
   *
   * @return Number of matched fields to the right (see docs).
   */
  [[nodiscard]] inline ulint get_up_match() const noexcept { return m_up_match; }

  /**
   * Returns the low_match value after a search.
   *
   * @return Number of matched fields to the left (see docs).
   */
  [[nodiscard]] inline ulint get_low_match() const noexcept { return m_low_match; }
